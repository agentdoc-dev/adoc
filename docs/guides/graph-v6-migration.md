...
That is the whole migration. Repeat runs are byte-identical for unchanged
source (guarded by `billing_pilot_migration_rebuild_is_byte_identical_across_runs`).
