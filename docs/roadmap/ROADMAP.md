...
Merge-queue CI runs core checks for pull requests and adds supported native packages
plus Windows qualification for queue candidates; see the [CI merge-queue plan](../plans/CI-MERGE-QUEUE.md).
Intel macOS is deferred for launch.
