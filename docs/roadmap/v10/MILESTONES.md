...
- Every group retains its complete effective group-name history; a decision records the name in effect at `evaluation_time`, replay compares it with that retained history, and a later rename preserves historical display (exit gate).
