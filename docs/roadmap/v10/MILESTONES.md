...
- Restrictive binding modes take effect immediately; a change between grant-conferring modes remains under the prior epoch until resync completes and records current source membership in the new epoch (exit gate).
