...
- Restrictive binding modes take effect immediately; a change to a grant-conferring mode remains under the prior epoch until resync completes and records current source membership in the new epoch (exit gate).
