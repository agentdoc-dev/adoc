...
G1A contract v9 is frozen in [`docs/pilots/g1a/evidence-contract-v9.yaml`](../../pilots/g1a/evidence-contract-v9.yaml) and validates against the single reusable [`agentdoc.evidence_contract.v0`](../../agent/v0/schema/agentdoc.evidence_contract.v0.schema.json) schema. The flawed [v1](../../pilots/g1a/cohort-v1-closure.md), [v2](../../pilots/g1a/cohort-v2-closure.md), and [v3](../../pilots/g1a/cohort-v3-closure.md) cohorts, the threshold-failing [v4](../../pilots/g1a/cohort-v4-closure.md) cohort, and the stop-ship [v5](../../pilots/g1a/cohort-v5-closure.md), [v6](../../pilots/g1a/cohort-v6-closure.md), [v7](../../pilots/g1a/cohort-v7-closure.md), and [v8](../../pilots/g1a/cohort-v8-closure.md) cohorts are closed without promotion, preserving their contracts and observations rather than rewriting them. The v9 readout remains a separate pass/fail artifact; publishing the criteria does not claim the gate passed.
