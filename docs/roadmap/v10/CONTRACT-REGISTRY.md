...
| `adoc.authorization_decision.v0` | adoc | E2.2, E2.6 | `allow`/`deny`/`insufficient_context` decision record with contract-tested freshness-bounded source ACL evidence |
