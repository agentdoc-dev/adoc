...
| `agentdoc.cloud.migration_request.v0` | cloud | E4.4 | exact-version migration-request transport; E7 HTTP source registration publishes the closed `register_source` payload branch while other migration operation semantics remain owner-reserved |
