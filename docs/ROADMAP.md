...
- The rest of the V7 cycle ([ROADMAP-V7.md](ROADMAP-V7.md)): V1.7 prose retrieval and the V7.2 pilot readiness gate (V7.1 docs-truth hygiene and V6.5 vocabulary completion have landed).
