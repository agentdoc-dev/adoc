...
fn lists_and_reads_all_stable_agent_resources() {
    ...
    let expected = [
        ...
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_configuration_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_configuration_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_fence_evidence.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_fence_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_admission.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_admission_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_result.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_transition_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_transition_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_cutover_context.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_begin_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_begin_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_context.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_import_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_accept_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_attestation.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_reconciliation_accept_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_rollback_context.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_rollback_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_rollback_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_fence_release_claim.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_fence_release_evidence.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_fence_release_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_fence_release_context.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_target_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_target_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_checkpoint_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_checkpoint_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_source_result.v0.schema.json",
        ...
        "adoc://agent/v0/schema/adoc.migration_request.v1.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_request.v1.schema.json",
        "adoc://agent/v0/schema/adoc.migration_receipt.v1.schema.json",
        "adoc://agent/v0/schema/adoc.migration_import.v1.schema.json",
        "adoc://agent/v0/schema/adoc.migration_qualification.v1.schema.json",
        "adoc://agent/v0/schema/adoc.migration_qualification_receipt.v1.schema.json",
        "adoc://agent/v0/schema/adoc.repository_inspection_request.v0.schema.json",
        "adoc://agent/v0/schema/adoc.repository_inspection_receipt.v0.schema.json",
